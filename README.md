...
I learned that express is powerful and we use it to convert our api code into JSON format. Its lightweight and very easy to unpack.
...
Resources are the database schema we use to structure our code.
